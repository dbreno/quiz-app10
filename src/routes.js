...
router.get('/', (_req, res) => res.redirect('/questions.html'));

router.get('/questions', isAuthenticated, async (_req, res) => {
...
router.get('/alternatives', isAuthenticated, async (_req, res) => {
...
router.post(
    ...
    celebrate({
        [Segments.BODY]: Joi.object().keys({
          ...
          cconfirmation_password: Joi.string().min(8),
        }),
    }),
    async (req, res) => {
...
router.use(function (error, _req, res, _next) {
